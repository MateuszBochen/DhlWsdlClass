<?php
/**
 * File for class DhlWsdlClassStructReceiverAddress
 ...
 */
/**
 * This class stands for DhlWsdlClassStructReceiverAddress originally named ReceiverAddress
 ...
 * @date 2015-01-13
 */
class DhlWsdlClassStructReceiverAddress extends DhlWsdlClassWsdlClass
{
    /**
     * The country
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for ReceiverAddress
     ...
     */
    public function __construct($_country = NULL,$_isPackstation = NULL,$_isPostfiliale = NULL,$_postnummer = NULL,$_name = NULL,$_postalCode = NULL,$_city = NULL,$_street = NULL,$_houseNumber = NULL,$_apartmentNumber = NULL)
    {
        parent::__construct(array('country'=>$_country,'isPackstation'=>$_isPackstation,'isPostfiliale'=>$_isPostfiliale,'postnummer'=>$_postnummer,'name'=>$_name,'postalCode'=>$_postalCode,'city'=>$_city,'street'=>$_street,'houseNumber'=>$_houseNumber,'apartmentNumber'=>$_apartmentNumber),false);
    }
    /**
     * Get country value
     * @return string|null
