<?php
/**
 * File for class DhlWsdlClassStructGetTrackAndTraceInfo
 ...
 */
/**
 * This class stands for DhlWsdlClassStructGetTrackAndTraceInfo originally named getTrackAndTraceInfo
 ...
 * @date 2015-01-13
 */
class DhlWsdlClassStructGetTrackAndTraceInfo extends DhlWsdlClassWsdlClass
{
    /**
     * The authData
     * Meta informations extracted from the WSDL
    ...
    public $shipmentId;
    /**
     * Constructor method for getTrackAndTraceInfo
     * @see parent::__construct()
     * @param DhlWsdlClassStructAuthData $_authData
     * @param string $_shipmentId
     * @return DhlWsdlClassStructGetTrackAndTraceInfo
     */
