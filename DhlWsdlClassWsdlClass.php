<?php
/**
 * File for DhlWsdlClassWsdlClass to communicate with SOAP service
 ...
 */
/**
 * DhlWsdlClassWsdlClass to communicate with SOAP service
 * 
 * @package DhlWsdlClass
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20140325-01
 * @date 2015-01-13
 */
class DhlWsdlClassWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://dhl24.com.pl/webapi2';
    /**
    ...
    /**
     * Constructor
     * @uses DhlWsdlClassWsdlClass::setLastError()
     * @uses DhlWsdlClassWsdlClass::initSoapClient()
     * @uses DhlWsdlClassWsdlClass::initInternArrayToIterate()
     * @uses DhlWsdlClassWsdlClass::_set()
     ...
     * @return DhlWsdlClassWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'DhlWsdlClassWsdlClass'))
            {
     ...
     * @uses DhlWsdlClassClassMap::classMap()
     * @uses DhlWsdlClassWsdlClass::getDefaultWsdlOptions()
     * @uses DhlWsdlClassWsdlClass::getSoapClientClassName()
     * @uses DhlWsdlClassWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('DhlWsdlClassClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = DhlWsdlClassClassMap::classMap();
     ...
     * If a class is named as {DhlWsdlClass}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('DhlWsdlClassSoapClient') && is_subclass_of('DhlWsdlClassSoapClient','SoapClient'))
            return 'DhlWsdlClassSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses DhlWsdlClassWsdlClass::WSDL_CACHE_WSDL
     * @uses DhlWsdlClassWsdlClass::WSDL_COMPRESSION
     * @uses DhlWsdlClassWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses DhlWsdlClassWsdlClass::WSDL_ENCODING
     * @uses DhlWsdlClassWsdlClass::WSDL_EXCEPTIONS
     * @uses DhlWsdlClassWsdlClass::WSDL_FEATURES
     * @uses DhlWsdlClassWsdlClass::WSDL_LOGIN
     * @uses DhlWsdlClassWsdlClass::WSDL_PASSWORD
     * @uses DhlWsdlClassWsdlClass::WSDL_SOAP_VERSION
     * @uses DhlWsdlClassWsdlClass::WSDL_STREAM_CONTEXT
     * @uses DhlWsdlClassWsdlClass::WSDL_TRACE
     * @uses DhlWsdlClassWsdlClass::WSDL_TYPEMAP
     * @uses DhlWsdlClassWsdlClass::WSDL_URL
     * @uses DhlWsdlClassWsdlClass::VALUE_WSDL_URL
     * @uses DhlWsdlClassWsdlClass::WSDL_USER_AGENT
     * @uses DhlWsdlClassWsdlClass::WSDL_PROXY_HOST
     * @uses DhlWsdlClassWsdlClass::WSDL_PROXY_PORT
     * @uses DhlWsdlClassWsdlClass::WSDL_PROXY_LOGIN
     * @uses DhlWsdlClassWsdlClass::WSDL_PROXY_PASSWORD
     * @uses DhlWsdlClassWsdlClass::WSDL_LOCAL_CERT
     * @uses DhlWsdlClassWsdlClass::WSDL_PASSPHRASE
     * @uses DhlWsdlClassWsdlClass::WSDL_AUTHENTICATION
     * @uses DhlWsdlClassWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses DhlWsdlClassWsdlClass::getSoapClient()
     * @uses DhlWsdlClassWsdlClass::getFormatedXml()
     ...
     * @uses DhlWsdlClassWsdlClass::getSoapClient()
     * @uses DhlWsdlClassWsdlClass::convertStringHeadersToArray()
     ...
     * @uses DhlWsdlClassWsdlClass::count()
     * @return int
     */
     ...
     * @uses DhlWsdlClassWsdlClass::getInternArrayToIterate()
     * @uses DhlWsdlClassWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses DhlWsdlClassWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses DhlWsdlClassWsdlClass::getInternArrayToIterateOffset()
     * @uses DhlWsdlClassWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses DhlWsdlClassWsdlClass::getInternArrayToIterateOffset()
     * @uses DhlWsdlClassWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see DhlWsdlClassWsdlClass::offsetGet()
     * @uses DhlWsdlClassWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses DhlWsdlClassWsdlClass::getAttributeName()
     * @uses DhlWsdlClassWsdlClass::__toString()
     * @uses DhlWsdlClassWsdlClass::_set()
     * @uses DhlWsdlClassWsdlClass::_get()
     * @uses DhlWsdlClassWsdlClass::setInternArrayToIterate()
     * @uses DhlWsdlClassWsdlClass::setInternArrayToIterateIsArray()
     * @uses DhlWsdlClassWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses DhlWsdlClassWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses DhlWsdlClassWsdlClass::item()
     * @uses DhlWsdlClassWsdlClass::length()
     * @return mixed
     */
