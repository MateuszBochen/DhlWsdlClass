<?php
/**
 * File for class DhlWsdlClassStructPieceDefinition
 ...
 */
/**
 * This class stands for DhlWsdlClassStructPieceDefinition originally named PieceDefinition
 ...
 * @date 2015-01-13
 */
class DhlWsdlClassStructPieceDefinition extends DhlWsdlClassWsdlClass
{
    /**
     * The type
     * Meta informations extracted from the WSDL
    ...
    public $euroReturn;
    /**
     * Constructor method for PieceDefinition
     ...
     */
    public function __construct($_type = NULL,$_width = NULL,$_height = NULL,$_length = NULL,$_weight = NULL,$_quantity = NULL,$_nonStandard = NULL,$_blpPieceId = NULL,$_euroReturn = NULL)
    {
        parent::__construct(array('type'=>$_type,'width'=>$_width,'height'=>$_height,'length'=>$_length,'weight'=>$_weight,'quantity'=>$_quantity,'nonStandard'=>$_nonStandard,'blpPieceId'=>$_blpPieceId,'euroReturn'=>$_euroReturn),false);
    }
    /**
     * Get type value
     * @return string|null
